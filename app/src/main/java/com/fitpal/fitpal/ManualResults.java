...
public class ManualResults extends AppCompatActivity {
...
//    int count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manual_results);
        ...
        name=findViewById(R.id.ManualFoodNameId);
        carbs=findViewById(R.id.ManualCarbId);
        energy=findViewById(R.id.ManualEnergyId);
        fat=findViewById(R.id.ManualFatId);
        protein=findViewById(R.id.ManualProteinId);
        mineral=findViewById(R.id.ManualMineralsId);
        calcium=findViewById(R.id.ManualCalciumId);
        fibre=findViewById(R.id.ManualFibreId);
        calories=findViewById(R.id.ManualCaloriesId);

        remarks=findViewById(R.id.ManualRemarksID);

        readAgain=findViewById(R.id.ManualReadAgainID);

        Intent in=getIntent();


        foodToSearch=in.getStringExtra("foodname");
        if(foodToSearch.isEmpty()){
            Log.d("mmfood","empfood");
        }
        Log.d("mmfood",foodToSearch);
...
//        print.Moisture="0";
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.POST,url,jsonObject1, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Log.d("mmresults",String.valueOf(response));
        ...
        readAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    Intent i=new Intent(getApplicationContext(),ManualInput.class);
                    startActivity(i);
                    finish();
